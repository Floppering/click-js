...
const GAME_NAME = 'Floppeclick!'; /* название игры */
const GAME_TIME = 90;  /* время игры (в секундах) */
...
function getTargetClick() {
    ...
    */
    ...
    targetReplaceInterval = setInterval(replaceTargetDiv, targetReplaceTime); //задаем новый интервал
